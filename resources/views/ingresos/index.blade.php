                                            ...
                                            <td>
                                                <form action="{{ route('ingresos.destroy', $ingreso->id) }}"
                                                    ...
                                                    <a class="btn btn-sm btn-primary "
                                                        href="{{ route('ingresos.show', $ingreso->id) }}"><i
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Registrar ingreso</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="ingreso" class="form-control" placeholder="Ingreso" required>
