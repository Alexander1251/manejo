                                ...
                                <tbody>
                                    @foreach ($escuelas as $escuela)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('escuelas.destroy', $escuela->id) }}"
                                                    method="POST">
                                                    <a class="btn btn-sm btn-primary "
                                                        href="{{ route('escuelas.show', $escuela->id) }}"><i
                                                            class="fa fa-fw fa-eye"></i></a>
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('escuelas.edit', $escuela->id) }}"><i
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Registrar escuela</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="escuela" class="form-control" placeholder="Escuela" required>
