        ...
        <div class="">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('practico-preguntas.update', $pregunta->id) }}" role="form"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value='{{$pregunta->pregunta}}' type="text" name="preugnta" class="form-control" placeholder="Pregunta" required>
