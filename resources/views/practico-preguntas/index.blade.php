...
@section('content')
                                ...
                                <tbody>
                                    @foreach ($preguntas as $pregunta)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('practico-preguntas.destroy', $pregunta->id) }}"
                                                    method="POST">
                                                    <a class="btn btn-sm btn-primary "
                                                        href="{{ route('practico-preguntas.show', $pregunta->id) }}"><i
                                                            class="fa fa-fw fa-eye"></i></a>
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('practico-preguntas.edit', $pregunta->id) }}"><i
    ...
    <!-- Modal -->
    <form action="{{ route('practico-preguntas.store') }}" method="POST" enctype="multipart/form-data">
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Registrar pregunta</h1>
