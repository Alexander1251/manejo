...
<body>
    ...
    <div class="container">
        ...
        <div class="derecha"><div class="cuadro"><b>CREDITO FISCAL</b> <br> <span style="color: red"><b>No. {{$detalle->id}}</b> </span> <br> <br><span style="font-size: 10px;">REGISTRO No.{{$empresaDatos->nrc}} <br> NIT: {{$empresaDatos->nit}}</span></div>
        </div>
    </div>
    ...
    <div class="container2">
        <div class="left">
          ...
          <b> Cliente: </b> {{$detalle->nombres}} {{$detalle->apellidos}}<br>
          <b>  Dirección: </b> {{$detalle->direccion}}<br>
          <b> Municipio:</b> {{$detalle->municipio}} <br>
          <b> Departamento:</b> {{$detalle->departamento}} <br>
        ...
        <div class="right">
            ...
            <b> NRC:</b> {{$detalle->nrc}} <br>
            <b> DUI:</b> {{$detalle->dui}} <br>
            <b> Giro:</b> {{$detalle->giro}} <br>
        ...
        <table class="tabla">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>$ {{($detalle->total*0.13 + $detalle->total)}}</td>
                </tr>
