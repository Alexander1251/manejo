...
<body>
    ...
    <div class="container">
        ...
        <div class="derecha"><div class="cuadro"><b>FACTURA</b> <br> <span style="color: red"><b>No. {{$detalle->id}}</b> </span> <br> <br><span style="font-size: 10px;">REGISTRO No.{{$empresaDatos->nrc}} <br> NIT: {{$empresaDatos->nit}}</span></div>
        </div>
    </div>
    ...
    <div class="container2">
        <div class="left">
          ...
          <b> SEÑOR(ES): </b> {{$detalle->nombres}} {{$detalle->apellidos}}<br>
          <b>  DIRECCION: </b><br>
          <b> DUI:</b> {{$detalle->dui}}
    ...
    <div class="container3">
        <table class="tabla">
            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align: left; line-height: 1.5;" colspan="2" rowspan="3" ><b>NOMBRE/CLIENTE: </b> <br> <br> <b>DUI/NIT:</b> <br> <br> <b>FIRMA:</b> </td>
