                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3"> <label for="dui">Dui *</label>
                                    <input id="dui" type="text" maxlength="10" name="dui" class="form-control"
                                        placeholder="Dui">
                                ...
                                <div class="mb-3"> <label for="nit">Nit</label>
                                    <input id="nit" type="text" maxlength="17" name="nit" class="form-control"
                                        placeholder="Nit ">
                                ...
                                <div class="mb-3"> <label for="nrc">NRC</label>
                                    <input type="number" name="nrc" class="form-control" placeholder="NRC ">
