...
<body>
    ...
    <div class="container">
        ...
        <div class="derecha"><div class="cuadro"><b>FACTURA</b> <br> <span style="color: red"><b>No. {{$expediente->id}}</b> </span> <br> <br><span style="font-size: 10px;">REGISTRO No.{{$empresaDatos->nrc}} <br> NIT: {{$empresaDatos->nit}}</span></div>
        </div>
    </div>
    ...
    <div class="container2">
        <div class="left">
          ...
          <b> SEÑOR(ES): </b> {{$expediente->cliente->nombres}} {{$expediente->cliente->apellidos}}<br>
          <b>  DIRECCION: </b><br>
          <b> DUI:</b> {{$expediente->cliente->dui}}
           
          
        </div>
        <div class="right">
            <b> FECHA: </b> {{date('d-m-Y')}} <br>
            <b>VENTA A CUENTA DE: </b> <br>
            <b>ORDEN No.</b>
    ...
    <div class="container3">
        <table class="tabla">
            ...
            <tbody>
                ...
                <tr>
                    <td style="text-align: left; line-height: 1.5;" colspan="2" rowspan="3" ><b>NOMBRE/CLIENTE: {{$expediente->cliente->nombres}} {{$expediente->cliente->apellidos}}</b> <br> <br> <b>DUI/NIT: {{$expediente->cliente->dui}}</b> <br> <br> <b>FIRMA:</b> </td>
