                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            ...
                            <form action="{{ route('reporte-ingresos/buscarIngresos') }}" method="POST">
                                @csrf
                        ...
                        @if (isset($detalles))
                            <div>
                                <div class="text-center"><br>
                                    <h4>REPORTE GENERAL DE INGRESOS DESDE {{ date('d-M-Y', strtotime($fechaInicio)) }} AL
                                        {{ date('d-M-Y', strtotime($fechaFin)) }}</h4>
                                        <a  class="btn btn-sm btn-success" href="{{route('reportes-excel.ingresos',['fecha_inicio' => $fechaInicio, 'fecha_fin' => $fechaFin])}}">Excel</a>
