...
@section('content')
                                ...
                                <tbody>
                                    @foreach ($categorias as $categoria)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('practico-categorias.destroy', $categoria->id) }}"
                                                    method="POST">
                                                    <a class="btn btn-sm btn-primary "
                                                        href="{{ route('practico-categorias.show', $categoria->id) }}"><i
                                                            class="fa fa-fw fa-eye"></i></a>
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('practico-categorias.edit', $categoria->id) }}"><i
    ...
    <!-- Modal -->
    <form action="{{ route('practico-categorias.store') }}" method="POST" enctype="multipart/form-data">
