...
@section('content')
                                ...
                                <tbody>
                                    @foreach ($licencia_tipos as $licencia)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('licencia-tipos.destroy', $licencia->id) }}"
                                                    method="POST">
                                                    <a class="btn btn-sm btn-primary "
                                                        href="{{ route('licencia-tipos.show', $licencia->id) }}"><i
                                                            class="fa fa-fw fa-eye"></i></a>
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('licencia-tipos.edit', $licencia->id) }}"><i
    ...
    <!-- Modal -->
    <form action="{{ route('licencia-tipos.store') }}" method="POST" enctype="multipart/form-data">
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Registrar Tipo de Licencia</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="licencia" class="form-control" placeholder="Tipo de licencia" required>
